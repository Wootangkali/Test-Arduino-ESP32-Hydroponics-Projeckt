...
// Use DHCP
  ...
  IPAddress stationIP   = IPAddress(192, 168, 4, 1);
  IPAddress gatewayIP   = IPAddress(192, 168, 1, 107);
...
// New in v1.4.0
IPAddress APStaticIP  = IPAddress(192, 168, 1, 109);
IPAddress APStaticGW  = IPAddress(192, 168, 1, 110);
