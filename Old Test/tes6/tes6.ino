...
if (millis() - myTimer3 >= 5000) {
  ...
  if (Wt < 23) {digitalWrite(relPin, HIGH); ioheat = 1;}//showmsgXY(110, 40, 2, &FreeSerifItalic18pt7b, "Heater ON");}

  else  { (digitalWrite(relPin, LOW)); ioheat = 0;}; //{ tft.setTextColor(GREEN); showmsgXY(110, 40, 2, &FreeSerifItalic18pt7b, "Heater OFF")};
