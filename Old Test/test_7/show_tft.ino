...
if (CurrentStatePonic == 0) {tft.setTextColor(RED);show_heater(120, 130, 2, &FreeSerif12pt7b, "PonDoliv ON");}

  else{tft.setTextColor(GREEN); show_heater(120, 130, 2, &FreeSerif12pt7b, "PonDoliv OFF");};
// tft.setTextColor(GREEN); 
