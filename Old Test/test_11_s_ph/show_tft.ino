void show_tft(void)
{
  ...
  mylcd.Print_String(String(rtc.getDateString()), 180, 0);
  mylcd.Print_String(String(rtc.getTimeString()), 180, 35);
  ...
  mylcd.Print_String("PPM  " + String(tdsValue), 0, 50);
  ...
  mylcd.Print_String("PH-" + String(pHValue), 0, 225);
