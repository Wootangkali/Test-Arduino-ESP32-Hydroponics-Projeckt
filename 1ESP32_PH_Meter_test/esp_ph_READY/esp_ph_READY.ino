...
#define Offset 18.28            //deviation compensate 17.70
#define LED 13
#define samplingInterval 3
#define printInterval 50
...
void loop() {
  ...
  if (millis() - samplingTime > samplingInterval)
  {
    ...
    voltage = avergearray(pHArray, ArrayLenth) * 3.825 / 4095;
    pHValue = -5.06 * voltage + Offset;
    samplingTime = millis();
  }
  if (millis() - printTime > printInterval)  //Every 800 milliseconds, print a numerical, convert the state of the LED indicator
  {
    ...
    //    lcd.write(B11011111);
    lcd.setCursor(1, 0);
    lcd.print(sensor1Data.temperature, 1);
    lcd.setCursor(11, 0);
    lcd.print(Wtemp);
    lcd.setCursor(0, 1);
    //    lcd.write(B11011111);
    ...
    lcd.print(pHValue);
    lcd.setCursor(13, 1);
    lcd.print(sensor1Data.humidity, 0);
    lcd.setCursor(15, 1);
    lcd.print("%");
    //    lcd.setCursor(9,3);
    //    lcd.print("PH");
    // Serial.println(Etemp);
    Serial.println("Temp: " + String(sensor1Data.temperature, 1) + "'C Humidity: " + String(sensor1Data.humidity, 0) + "%");
